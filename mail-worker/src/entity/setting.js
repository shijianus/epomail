...
export const setting = sqliteTable('setting', {
	...
	aiMaxTokens: integer('ai_max_tokens').default(2048).notNull(),
	aiAdminOnly: integer('ai_admin_only').default(0).notNull(),
	...
	welcomeTemplates: text('welcome_templates').default('{}').notNull(),
	welcomeLang: text('welcome_lang').default('zh').notNull(),
	globalEmailConfig: text('global_email_config').default('{}').notNull(),
