const zh = {
	...
	attachmentNotAllowed: '当前身份分组仅支持发送纯文本邮件，暂不支持发送附件！请前往 blog.epomail.com 参与互动升级至 LV.1 活跃学者解锁！',
	visitorSendBan: '参观者分组仅供功能演示与架构巡检，禁止发送外发邮件！如需发件请注册普通用户。',
	moderatorSelfEditDenied: '协管者/管理员无权修改自身所在分组的权限配置！',
	masterEditDenied: '无权修改站长分组或站长用户！',
