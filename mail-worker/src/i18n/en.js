const en = {
	...
	attachmentNotAllowed: 'Sending attachments is not permitted for your current group (plaintext only). Participate on blog.epomail.com to level up to LV.1!',
	visitorSendBan: 'The Visitor role is for UI/UX inspection and sandbox demonstration only. Outbound sending is disabled.',
	moderatorSelfEditDenied: 'Moderators cannot modify their own group permissions or roles!',
	masterEditDenied: 'Permission denied: Cannot modify the Webmaster group or master account!',
	...
	emailSizeLimit: 'Total email size cannot exceed {{msg}}',
	perms: {
		"邮件": "Emails",
		"邮件发送": "Send Email",
		"邮件删除": "Delete Email",
