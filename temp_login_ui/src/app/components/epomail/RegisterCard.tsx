...
export function RegisterCard({ canvasRef, onSwitch, sysConfig }: RegisterCardProps) {
            ...
            <div className="mb-8 flex flex-col items-center text-center">
              ...
              >
                {(() => {
                  ...
                  return currentI18n.registerSubtitle || (isZh ? "加入星际信道，建立专属通信节点" : "Join the network. Establish your node.");
                })()}
              </p>
            </div>

            <RegisterForm canvasRef={canvasRef} onSwitch={onSwitch} sysConfig={sysConfig} />
          </div>
        </div>
      </motion.div>
    </div>
