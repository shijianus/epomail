const en = {
    ...
    welcomeEmailDesc: 'Send official onboarding email to all users with single-instance storage, verified badge, important & todo auto-tagging.',
    ...
    welcomeBroadcastConfirmMsg: 'This will broadcast the official welcome email to all active users with single-instance storage, verified badge, important & todo tags, and auto-cleanup. Proceed?',
    ...
    editMode: 'Compose Mode',
    previewMode: 'Inbox Preview',
    richTextMode: 'Rich Text View',
    markdownSourceMode: 'Source / Markdown',
    clearFormat: 'Clear Content',
    previewLightMode: 'Light Inbox Preview',
    previewDarkMode: 'Dark Inbox Preview',
    emailSettings: 'Email Rules & Retention',
    welcomeRecentBroadcast: 'Last Broadcast',
    audienceTarget: 'Recipients',
    mailAttributes: 'Email Attributes',
    systemAutomationRules: 'System Automation Rules',
    broadcastConfirmHighRiskTitle: '⚠️ Confirm Broadcast Welcome Email?',
    broadcastConfirmHighRiskMsg: 'This will broadcast the official welcome email to all existing and new registered users. This action is IRREVERSIBLE. Verified badge, important & todo tags, and auto-cleanup will be applied automatically. Proceed immediately?',
