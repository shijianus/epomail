const en = {
    ...
    staticUiNotice: 'Static UI is not applied when no background image is set (system defaults to Dynamic UI); it only activates after configuring an image.',
    dynamicUiBadge: 'Built-in Canvas Particle System',
    dynamicUiFeatureDesc: 'System defaults to dynamic space interface with 3D parallax, node glow, and multi-state alert customizations when no static background is configured.',
    dynamicUiStatus: 'Active (Default)',
